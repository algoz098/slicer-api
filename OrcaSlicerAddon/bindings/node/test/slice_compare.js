/*
 Node test that replicates OrcaSlicerAddon/test_slice.sh using the Node addon.
 ...
 Usage (from repo root):
   cd OrcaSlicerAddon && node bindings/node/test/slice_compare.js
*/
...
// Resolve paths
// __dirname = <repo>/OrcaSlicerAddon/bindings/node/test
const repoRoot = path.resolve(__dirname, '../../../..');
const cliRoot = path.join(repoRoot, 'OrcaSlicerAddon');
...
(async () => {
  ...
  try {
    ...
    // If ORCACLI_RESOURCES is relative, resolve it against the addon root (so '../OrcaSlicer/resources' works when run from OrcaSlicerAddon)
