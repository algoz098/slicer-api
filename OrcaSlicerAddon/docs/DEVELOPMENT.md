# OrcaSlicerAddon Development Guide (legacy)

Note: The CLI was removed. This document is legacy and will be replaced with addon-only developer docs in English. Path references to OrcaSlicerCli will be updated to OrcaSlicerAddon over time.
