# OrcaSlicer Addon — Basic Usage Examples

This document shows how to use the Node.js addon (N-API) for common slicing tasks. The CLI has been removed from this repository.

## Install and Build (addon)
