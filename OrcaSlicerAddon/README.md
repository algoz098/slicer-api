# OrcaSlicerAddon (Node.js addon focus)

Important: The CLI has been removed from this repository. This README is legacy and will be rewritten to cover addon-only workflows in English. For now, please refer to the repository root README for up-to-date quick start.
